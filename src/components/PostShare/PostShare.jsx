...
const handleSubmit = (e)=>{
  ...
  return (
    <div className='PostShare'>
        <img src={user.coverPicture?serverPublic+user.profilePicture:serverPublic+"defaultProfile.png"} alt="profileImg"/>
        <div>
            ...
            <div className='postOptions'>
                ...
                <div className='option' style={{color:"var(--shedule)"}}><UilSchedule/>Shedule</div>
